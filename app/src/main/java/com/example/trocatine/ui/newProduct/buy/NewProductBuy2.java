package com.example.trocatine.ui.newProduct.buy;
...
import com.example.trocatine.ui.newProduct.trade.NewProductTrade1;
import com.example.trocatine.ui.newProduct.trade.NewProductTrade3Camera;
...
public class NewProductBuy2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_product_buy2);
    ...
    public void onClickNext(View view) {
        ...
        saveProduct(UserUtil.email, ProductUtil.name, ProductUtil.description, ProductUtil.value,
                Long.parseLong("1"),false, tags, category, UserUtil.token);

        Intent intent = new Intent(NewProductBuy2.this, NewProductTrade3Camera.class);
    ...
    public void OnClickBack(View view) {
        Intent intent = new Intent(NewProductBuy2.this, NewProductTrade1.class);
        startActivity(intent);
    }
